...
def main():
    ...
    material_wood_columns = [col for col in filtered_df.columns if 'OTHER MATERIAL' in col]
    wood_columns = [col for col in filtered_df.columns if col.startswith('O.M')]
